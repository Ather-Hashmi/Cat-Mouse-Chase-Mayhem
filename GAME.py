...
#title and icon
pygame.display.set_caption("Cat Mouse Chase Mayhem")
icon= pygame.image.load("icon.png")
pygame.display.set_icon(icon)

#Loading Assests
titleIMG = pygame.image.load("pixel grass.png")
obstacleIMG =pygame.image.load("flower ob2.png")
cheeseIMG = pygame.image.load("flower cheese.png")
playerIMG = pygame.image.load("grass mouse.png")
catIMG =  pygame.image.load("grass cat 1.png")
cat2IMG = pygame.image.load("grass cat 2.png")
background = pygame.image.load("background.jpeg")
playerIMG = pygame.transform.scale(playerIMG, (50,60))
catIMG = pygame.transform.scale(catIMG, (50,60))
cheeseIMG = pygame.transform.scale(cheeseIMG, (50,60))
obstacleIMG= pygame.transform.scale(obstacleIMG, (50, 60))
titleIMG= pygame.transform.scale(titleIMG, (50, 60))
cat2IMG = pygame.transform.scale(cat2IMG, (50,60))
font= pygame.font.Font("freesansbold.ttf", 32)
font2= pygame.font.Font("freesansbold.ttf", 60)
#Background MUsics
mixer.music.load("Ghostrifter-Official-Deflector.mp3")
mixer.music.play(-1)

#game music
jump= mixer.Sound("jump.wav")
cheese= mixer.Sound("cheese.wav")
caught= mixer.Sound("caught.wav")
...
def starting(): #displays intructions
  ...
  msg2=font.render("BUT cats can use them too!", True,(0,0,0))
  screen.blit(msg,(50,600))
  screen.blit(msg2, (150,670))
...
def getShortestPath(graph, source, destination):
  ...
  while parents[current_node] != None:
    path.append((parents[current_node], current_node))
...
pixels = LoadPixelGrid("pixel_grid.txt")
cordinate_map = LoadCordMap("location.txt")
game_map = LoadGraph("map.txt")
score = 0
